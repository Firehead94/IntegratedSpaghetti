 ...
 * @author Justin
 */
public class Course_old implements Serializable, Comparable<Course_old> {
    ...
    @Override
    public int compareTo(Course_old other) {
    ...
    public boolean equals(Object other) {
         if (!(other instanceof Course_old)){
             return false;
         }
         Course_old otherCourse = (Course_old) other;
